...
const DEFAULT_URL = "https://www.olx.com.br/estado-pe?q=aluguel";
// https://www.olx.com.br/estado-pe?q=kitnet
// https://www.olx.com.br/estado-pe?q=aluguel
  ...
  for (let page = 1; page <= pageLimit; page++) {
    ...
    if (page === 1) {
      ...
      try {
        ...
        console.error(
          `Listing page abortada (continua com ${allAds.length} anúncios já coletados): ${pageUrl}\n  ${msg}`
        );
        break;
      }
    }
